...
{
    class Dialog_RenamePocketDimensionEntranceBase : Dialog_Rename<IRenameable>
    {
        private string buildingSeed;
         
        public Dialog_RenamePocketDimensionEntranceBase(Building_PocketDimensionEntranceBase building) : base((IRenameable)null)
        {
